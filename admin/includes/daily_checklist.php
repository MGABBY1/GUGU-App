...
<section class="panel daily-checklist" id="checklist">
  ...
  <ol class="daily-steps">
    ...
    <li class="daily-step <?= $doneQueue ? 'is-done' : 'is-todo' ?>">
      ...
      <a class="btn-sm <?= $doneQueue ? 'ok' : 'warn' ?>" href="#listings"><?= $doneQueue ? 'View queue' : 'Open queue' ?></a>
    </li>
    <li class="daily-step <?= $donePay ? 'is-done' : 'is-todo' ?>">
      ...
      <a class="btn-sm <?= $donePay ? 'ok' : 'warn' ?>" href="#listings"><?= $donePay ? 'All paid' : 'Confirm pay' ?></a>
    </li>
    <li class="daily-step <?= $doneApprove ? 'is-done' : 'is-todo' ?>">
      ...
      <a class="btn-sm <?= $doneApprove ? 'ok' : '' ?>" href="#listings"><?= $doneApprove ? 'Caught up' : 'Approve now' ?></a>
    </li>
    <li class="daily-step <?= $doneQueue ? 'is-done' : 'is-todo' ?>">
      ...
      <a class="btn-sm danger" href="#listings">Reject junk</a>
    </li>
